...
==========================
This version of poets only supports resampling to a daily, weekly, monthly or dekadal interval, with values at the period end.
...
If you want to youse your own shapefile, please read `Usage of custom shapefiles`_.

If you want the data to be resampled globally, just skip the regions parameter.
